...
In order to chat, two users A and B should something similar to the following:
    ...
    User B (at 10.0.0.16):
    $ python speak.py --destination 10.0.0.15 --port 9999 --protocol TCP --sample-latency 20 --loss 0
...
Following are some other valid examples of startup conditions:
    ...
    User A (at 10.0.0.15):
    $ python speak.py --be-host --destination 10.0.0.16 --port 9999 --protocol TCP --sample-latency 10 --loss 10
    User B (at 10.0.0.16):
    $ python speak.py --destination 10.0.0.15 --port 9999 --protocol TCP --sample-latency 10 --loss 5
